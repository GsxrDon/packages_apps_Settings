/*
 * Copyright (C) 2012 Nexus Evolution
 *
...
public class NavbarStyleDimenSettings extends SettingsPreferenceFragment implements
    ...
    public void refreshSettings() {
        ...
        try{
            ...
            defaultAlpha = 0.6f;
                     Settings.System.putFloat(getActivity().getContentResolver(), Settings.System.NAVIGATION_BAR_BUTTON_ALPHA, 0.0f);
        }
        ...
        switch (item.getItemId()) {
            case R.id.reset:
                ...
                Settings.System.putFloat(getActivity().getContentResolver(),
                       Settings.System.NAVIGATION_BAR_BUTTON_ALPHA, 0.01f);
